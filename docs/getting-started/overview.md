...
- Bạn có thể gửi và nhận [native tokens](/docs/native-tokens/), bao gồm cả ada.
- Bạn có thể ủy quyền ada của mình cho một trong các nhóm  [các pools hiện có](/docs//docs/showcase?tags=pooltool) và lĩnh phần thưởng.
- Bạn có thể [sử dụng ada để bỏ phiếu](/docs/governance/project-catalyst#participate-as-a-voter) tđể phân phối ada trị giá hơn một tỷ đô la từ kho bạc để tài trợ cho các đề xuất do cộng đồng thúc đẩy trên [Project Catalyst](/docs/governance/project-catalyst).
...
- Cardano mang đến quỹ đầu tư mạo hiểm của mình. Nếu bạn xây dựng trên Cardano, bạn có thể nhận được [tài trợ cho dự án](/docs/governance/project-catalyst). Cứ sau 6 đến 8 tuần, các dự án có thể được cộng đồng Cardano đề xuất, thảo luận và bỏ phiếu.
...
- Bạn có thể [tích hợp Cardano](/docs/integrate-cardano) vào website và dịch vụ hiện có.
...
- Bạn có thể chứng minh sự tồn tại của tệp, văn bản hoặc bất kỳ dữ liệu nào khác tại một thời điểm cụ thể bằng [transaction metadata](/docs/transaction-metadata/). và bạn có thể dụng [metadata của giao dịch](/docs/transaction-metadata/)để xác minh sản phẩm vật lý và các sản phẩm chính hangx.
- Bạn có thể [thiết lập, quản lý và duy trì một nhóm cổ phần](/docs/operate-a-stake-pool/note) trên Cardano.
- Bạn có thể [tạo hợp đồng thông minh](/docs/smart-contracts/overview).
